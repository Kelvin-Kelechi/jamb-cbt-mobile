  ...
  return (
    <ScreenContainer style={styles.container}>
      ...
      <View style={styles.titleContainer}>
        <ThemedText type="title">Examine Yourself</ThemedText>
      </View>
      <ThemedText>Select a subject you wish to study</ThemedText>
      <SubjectSelect mode="exam" onSelectedChange={setSelected} />
        ...
        <Pressable
          ...
          onPress={() => {
            if (selected.length > 0) {
              router.push({ pathname: "/mode/past-options", params: { subjects: JSON.stringify(selected), mode: "exam" } });
            }
          }}
        >
